...
const ar: Dict = {
  ...
  "oauth.kicker": "طلب ربط تطبيق",
  "oauth.title": "ربط {client} بحسابك",
  "oauth.body":
    "سيتمكن {client} من استخدام أدوات طمّني يا دكتور نيابةً عنك أثناء تسجيل دخولك.",
  "oauth.redirect": "عنوان العودة",
  "oauth.scopeProfile": "مشاركة بياناتك الأساسية",
  "oauth.scopeEmail": "مشاركة بريدك الإلكتروني",
  "oauth.scopeTools": "قراءة استشاراتك وتقاريرك الطبية ووصفاتك المتاحة لك فقط",
  "oauth.boundary": "لا يتجاوز ذلك صلاحياتك داخل المنصة أو سياسات حماية البيانات.",
  "oauth.approve": "موافقة",
  "oauth.deny": "إلغاء الربط",
  "oauth.unknownClient": "تطبيق خارجي",
  "oauth.noRedirect": "لم يُرجع خادم التفويض عنوان عودة.",
...
const en: Dict = {
  ...
  "oauth.kicker": "App connection request",
  "oauth.title": "Connect {client} to your account",
  "oauth.body":
    "{client} will be able to use Tammeni Doctor's tools as you while you are signed in.",
  "oauth.redirect": "Redirect URI",
  "oauth.scopeProfile": "Share your basic profile",
  "oauth.scopeEmail": "Share your email address",
  "oauth.scopeTools": "Read the consultations, medical reviews and prescriptions you can access",
  "oauth.boundary":
    "This does not bypass this app's permissions or data-protection policies.",
  "oauth.approve": "Approve",
  "oauth.deny": "Cancel connection",
  "oauth.unknownClient": "an app",
  "oauth.noRedirect": "The authorization server returned no redirect URL.",
  ...
  "payment.doctor.fee": "Consultation fee",
  "payment.info.title": "Payment Information",
  "payment.info.number": "Vodafone Cash number",
  "payment.info.holder": "Account holder",
  "payment.info.amount": "Amount due",
  "payment.info.copy": "Copy number",
  "payment.info.copied": "Number copied",
  "payment.info.qr": "Scan for quick pay",
  "payment.steps.title": "Payment Instructions",
  "payment.steps.1": "Transfer the consultation fee to the Vodafone Cash number.",
  "payment.steps.2": "Keep the payment receipt.",
  "payment.steps.3": "Take a screenshot/photo of the receipt.",
  "payment.steps.4": "Upload the receipt and enter the transaction reference.",
  "payment.steps.5": "Press Confirm Payment.",
  "payment.upload.title": "Payment Receipt",
  "payment.upload.button": "Upload receipt screenshot",
  "payment.upload.replace": "Replace image",
  "payment.upload.remove": "Remove image",
  "payment.upload.hint": "Accepted: JPG, PNG. Max 5 MB.",
  "payment.upload.tooLarge": "File is too large (max 5 MB).",
  "payment.upload.invalidType": "Please choose a valid image.",
  "payment.reference.label": "Transaction Reference",
  "payment.reference.placeholder": "e.g., 1234567890",
  "payment.reference.required": "Enter the transaction reference.",
  "payment.receipt.required": "Please upload the receipt image.",
  "payment.confirm": "Confirm Payment",
  "payment.confirming": "Submitting…",
  "payment.status.pending.title": "Payment Pending Approval",
  "payment.status.pending.body": "Your payment is waiting for approval. It will be reviewed shortly.",
  "payment.status.pending.locked": "You can't start the chat until your payment is approved.",
  "payment.status.approved.title": "Payment Approved",
  "payment.status.approved.body": "Thank you — you can now start the consultation chat.",
  "payment.status.approved.cta": "Start Consultation Chat",
  "payment.status.rejected.title": "Payment Rejected",
  "payment.status.rejected.body": "Your payment receipt was not accepted. Please try again.",
  "payment.status.rejected.reason": "Rejection reason",
  "payment.status.rejected.retry": "Upload a new receipt",
  "payment.error.generic": "Could not submit payment. Try again.",
  "payment.consult.awaiting": "Waiting for payment approval before you can chat.",
  "payment.consult.viewStatus": "View payment status",
};
